...
public class TodoCLI {
    ...
    public TodoCLI(TaskManager manager, Scanner scanner, String persistenceFile) {
    ...
    public void run() {
        ...
        do {
            ...
            TaskPersistence.save(manager.getTasks(), persistenceFile);
        } while (op != 0);
    }
    ...
    public LocalTime readTime(String msg) {
        while (true) {
            System.out.print(msg);
